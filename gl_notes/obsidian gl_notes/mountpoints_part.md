...
**¿Qué hay en la partición `swap`?**
     La memoria swap se hace presente cuando la RAM se llena, encargándose de tomar las tareas menos activas, y las lleva al espacio en el disco que swap tiene reservado para sí. Sin embargo, hoy en día pocas computadoras requieren de su servicio gracias a la capacidad que fue ganando la RAM. ^a6de26
